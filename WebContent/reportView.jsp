...
<body>
	...
	<nav
		...
		<div class="w3-container">
			<h3 class="w3-padding-64">
				<b>BIG KPC</b><br>
				<font size=4px> : ${sessionScope.id }</font>  <font size=2px><a "> (logout)</a></font>
			</h3>
		</div>
	...
	<div style="height: 600px"></div>
		...
		<!-- Sector Analysis -->
		<div class="w3-container" id="Sector Analysis" style="margin-top: 75px">
			<h1 class="w3-xxxlarge w3-text-indigo">
				<b>Sector Analysis</b>
			</h1>
			<hr style="width: 50px; border: 5px solid #144169" class="w3-round">
			...
			<table class="table2" style="width: 80%; border-style: hidden; font-family:'Jeju Gothic', sans-serif;">
				<tr>
